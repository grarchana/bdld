...
data = np.loadtxt("avgsd_scaling1.data")
...
plt.text(0.95, 0.9, 'Scaling 1 - Seed 1', horizontalalignment='right', transform=plt.gca().transAxes, bbox=dict(facecolor='white', alpha=0.5))

# Save the figure
plt.savefig('avgsd_scaling1_seed1.png')
