...
filenames = ["fes_bo5_s10.png", "fes_bo5_s5.png", "fes_bo5_s2.png", "fes_bo5_s1.png"]
scaling_values = [10, 5, 2, 1]

# Create a 2x2 subplot grid
fig, axes = plt.subplots(nrows=2, ncols=2, figsize=(10, 8))
fig.suptitle('FES Plots with Different Scalings,bandwidth=0.5')
...
# Save the figure
plt.savefig('subplots_fes_scaling_bo5.png')
